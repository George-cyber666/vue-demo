// pages/activity/index/questionnairetwo.js
...
Page({
  data: {
    ...
    str:['0','1','2','3','4','5','6','7'],
    strarray:['单人居住','两口之家','三口之家','二孩家庭','三代同堂一孩','三代同堂二孩','多孩家庭','其他'],
    indexid:'',
    option:'',
    shareTitle:'',
    shareImg:''
  ...
  clicktoplan(){
    if(this.data.option==''){
      ...
      // console.log(wx.getStorageSync('answerArr'));
      wx.redirectTo({
        url: '/pages/thirdPartyActivity/activity/index/questionnairethr'
      });
    }
